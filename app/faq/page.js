	...
	return (
		<div className={styles.faq}>
			...
			<div className={styles.question}>
				...
				<p>
					We have a 7 day live fish guarantee on most fish. <br/> We require a
					...
					tanks, or gross negligence.<br/> Nitrates over 100, Ammonia over 0.25, and
					nitrites over 1 void any guarentee. <br/> Guarentee also does not cover
					stingrays or other delicate exotic fish.
				</p>
			</div>
			<div className={styles.question}>
				<h2>Do you sell aquariums and supplies?</h2>
				<p>
					Absolutely!<br/> We sell both new and used aquariums and accessories.<br/> Used
					equipment is available intermittently as we aquire it. We can order
					new tanks and have them in within a week.<br/> The reason for any lead time
			...
			<div className={styles.question}>
				...
				<p>
					There can be some flexibility!<br/> Though, some fish are more flexible
					than others. More often than not, the more fish purchased, the more we
					can negotiate price!<br/> Our prices are already reasonable, though we are
