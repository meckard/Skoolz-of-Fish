        ...
        <div className={styles.contactPage}>
            <div className={styles.contactUs}>
                ...
                <form className={styles.contactForm} onSubmit={handleSubmit}>
                    <input type="text" onChange={nameField} value={name} placeholder="Name" name="name"/>
                    <input type="email" onChange={emailField} value={email} placeholder="Email" name="email"/>
                    <textarea placeholder="Message Here" onChange={messageField} value={message} name="message"></textarea>
